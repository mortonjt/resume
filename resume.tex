...
\begin{rSection}{Education}
  \begin{tabular}{ll}
    ...
    2014 - Present  & IQ Biology student \\
    \textbf{Undergraduate}    & Miami University \\
    2010 - 2014   & B.S. in Computer Science \\
...
\begin{rSection}{Honors}
  \begin{tabular}{ll}
    ...
    $\bullet$ & \textbf{Goldwater Scholar}, 2013\\
    $\bullet$ & \textbf{Cum Laude}, Miami University Computer Science, 2014\\
    $\bullet$ & \textbf{Cum Laude}, Miami University Electrical Engineering, 2014\\
    $\bullet$ & \textbf{Harrison Scholar}, Miami University, 2010-2014\\
    $\bullet$ & \textbf{First place}, Institute of Navigation (ION) Autonomous Snow Plow Competition, 2014\\  
    $\bullet$ & \textbf{Best Presentation and Best Report}, ION Autonomous Snow Plow Competition, 2014\\
    ...
    $\bullet$ & \textbf{R.L. Edwards Scholarship}, Department of Physics, Miami University, 2013\\
    $\bullet$ & \textbf{Mary Jeannette and Clifford Harvey Scholarship}, Mathematics Department, Miami U., 2013\\
    ...
    $\bullet$ & \textbf{Joseph A. Culler} Award, Department of Physics, Miami University, 2011\\
    $\bullet$ & \textbf{R.L. Edwards Scholarship}, Department of Physics, Miami University, 2011\\
    $\bullet$ & \textbf{Joseph A. Culler Award}, Department of Physics, Miami University, 2010\\
...
\begin{rSection}{Experience}
  ...
  $\bullet$ Developed software tool to identify bacteriocin associated gene clusters\\[3 mm]
...
\begin{rSection}{Skills}
  ...
  \begin{tabular}{llll}
     ...
     $\bullet$ Matlab   &  $\bullet$ R                 &   $\bullet$ Unix   &   $\bullet$ SQL \\ 
...
\begin{rSection}{Publications}
  \begin{tabular}{ll}
      $\bullet$ & Morton, J.,  Abrudan, P.,  Figuegoaa, N., Liang, C., Karro, J. \\
                    & SCOPE++: Sequence Classification Of homoPolymer Emissions, \textit{Genomics}, 2014
  \end{tabular}
\end{rSection}

\begin{rSection}{Presentations}
  \begin{tabular}{ll}
    $\bullet$  & Morton, J., Freed, S. Lee, S. Friedberg, I. A pipeline for Identifying Bacteriocin-Associated \\ 
                    & Gene Clusters. ISMB Boston, 2014\\
    $\bullet$  & Morton, J., Freed, S. Lee, S. Friedberg, I. Discovering the Next Antibiotic \\
                    & Ohio Space Grant Consortium, Cleveland OH, 2014 \\
    $\bullet$  & Morton, J., P., Abrudan, J. Karro, C. Liang , ÄúSequence classification of homopolymer emissions \\
                    & (SCOPE),‚Äù Great Lakes Bioinformatics Conference, Pittsburgh, PA, 2013\\
    $\bullet$  & Morton, J., P., Abrudan, J. Karro, C. Liang , ÄúSequence classification of homopolymer emissions \\
                    & (SCOPE), Ohio Space Grant Consortium, Cleveland OH, 2013\\
    $\bullet$  & Morton, J., P., Abrudan, J. Karro, C. Liang , úSequence classification of homopolymer emissions \\
    ...
    $\bullet$  & Morton, J., J. Karro, C. Liang, ‚ÄúA novel approach for identifying poly(A) tails in \\
                    & raw cDNA sequence data using General Hidden Markov Models, Genome Informatics \\
                    & Cold Spring Harbor, NY, November 2011.\\
    $\bullet$  & Morton, J., C., Liang, and J. Karro. scrapplusplus -- SCRAP \\
    ...
    $\bullet$  & Morton, J., J. Karro, and C. Liang. scopeplusplus -- SCOPE \\
...
\begin{rSection}{Activities}
  \begin{tabular}{ll}
    $\bullet$ & Sigma Pi Sigma, Spring 2014 \\
    $\bullet$ & Tau Beta Pi, Spring 2014 \\
    $\bullet$ & Eta Kappa Nu, Spring 2014 \\
    ...
    $\bullet$ & Miami University Men‚Äôs Glee Club, Fall 2011, Spring 2014\\
